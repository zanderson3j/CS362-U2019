...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    ...
    case minion:
      return minionEffect(currentPlayer, choice1, choice2, state, handPos);
    ...
    case tribute:
      return tributeEffect(currentPlayer, nextPlayer, state, tributeRevealedCards);
...
int minionEffect(int currentPlayer, int choice1, int choice2, struct gameState *state, int handPos) {
  ...
  if (choice1) { //+2 coins
    ...
    drawCards(4, currentPlayer, state);
...
int ambassadorEffect(int currentPlayer, int choice1, int choice2, struct gameState *state, int handPos) {
  ...
  state->supplyCount[state->hand[currentPlayer][choice1]] += choice2;  //increase supply count for choosen card by amount being discarded
  ...
  for (int i = 0; i < state->handCount[currentPlayer]; i++) { //trash copies of cards returned to supply
    if (j > 0 && state->hand[currentPlayer][i] == state->hand[currentPlayer][choice1]) {
...
int tributeEffect(int currentPlayer, int nextPlayer, struct gameState *state, int *tributeRevealedCards) {
...
void drawCards(int numCards, int player, struct gameState *state) {
